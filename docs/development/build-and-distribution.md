...
진단과 봉합은 [`sessions/2026-08-01-input-focus-reset-plan.md`](sessions/2026-08-01-input-focus-reset-plan.md) §2~§3에 있다. 백로그 항목은 **F65**.
...
**아직 결정된 것은 아니다.** 로드맵은 "v2 = Steam PC"까지만 적었고 네이티브를 택한다는 기록은 어디에도 없다. 지금 확인된 것은 **선택지가 실재한다**는 사실까지다.
