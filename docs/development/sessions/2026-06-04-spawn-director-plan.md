...
> - **상태:** 완료 — 구현·검증·수동 QA 통과, PR 승인(머지 대기, PR #25)
...
- [x] `SpawnDirector.test.ts` GREEN (피처 15/15 + 전체 스위트 102/102, 커밋 2a31040)
- [x] 인게임: 웨이브가 오르면 빠른 적·탱키 적이 섞여 나옴(스탯 차이 체감 — 같은 모양이라도 속도/맷집 다름)
- [x] 기존 단일 적 스폰·추적·접촉 대미지 회귀 없음
